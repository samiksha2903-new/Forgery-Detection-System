...
const NavBar = () => {
  ...
  return (
    <nav className="w-full h-24 p-7 shadow-lg shadow-purple-300 flex justify-between items-center bg-indigo-950 px-10">
      <div className="flex items-center gap-4 ml-68">
        <SiDocsdotrs className="text-white text-4xl" />
        <h1 className="text-4xl w-full text-center font-extrabold m-7 bg-gradient-to-r from-pink-400 to-blue-400 text-transparent bg-clip-text">
